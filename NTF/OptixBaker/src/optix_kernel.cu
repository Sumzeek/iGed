...
// Compile for use "nvcc -I"C:/ProgramData/NVIDIA Corporation/OptiX SDK 9.0.0/include" --ptx optix_kernel.cu -o optix_kernel.ptx -arch=compute_75"
// Compile for use "nvcc -I"C:/ProgramData/NVIDIA Corporation/OptiX SDK 9.0.0/include" --ptx optix_kernel.cu -o optix_kernel.ptx -arch=compute_86"
