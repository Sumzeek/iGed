...
# Ensure PTX path (if not built, this may raise at runtime)
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "OptixBaker/assets"))
import optixbaker
